            ...
            <div className="container">
                <div className="row g-5">
                    <RichText.Content
                        ...
                        value = { title }
                    />
                    <div className="col-lg-6 wow fadeIn order-md-2" data-wow-delay="0.5s">
                        <img className='img-fliud' src={ imageUrl } alt={ imageAlt } />
                    </div>
                    <div className="col-lg-6 d-flex flex-column justify-content-center wow fadeIn order-md-1" data-wow-delay="0.1s">
                        <RichText.Content
                            tagName = 'p'
                            className = 'mb-4'
                            value = { content }
